            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {ingredientTypes.filter(i => i.active).map(type => {
                  ...
                  const currentRecipe = fillingRecipes.find(r => r.id === formData.recipeId);
                      ...
                      <div className="flex items-start gap-3 cursor-pointer" onClick={() => activeLot && toggleIngredient(type.id)}>
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-start gap-2">
                            ...
                            {recipeIngredient && (
                              <span className="text-[10px] bg-amber-200 text-amber-800 px-1.5 py-0.5 rounded font-bold whitespace-nowrap">
